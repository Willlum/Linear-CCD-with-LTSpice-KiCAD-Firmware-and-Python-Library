...
"""
TCD1304Rev2Controller - Control module for TCD1304 CCD Sensor
...
class LccdController:
    """
    Main controller for TCD1304 CCD sensor communication and data acquisition.
    
    Handles serial port communication, device configuration, data streaming,
    ...
    def __init__( self, portspec, readtimeout=1., writetimeout=1., monitor=True, graphics=True,
        ...
        if monitor and not HAS_TEXT_WINDOW:
